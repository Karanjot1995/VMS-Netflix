    ...
    if(Object.keys(data).length){
        return (
            <div className="pt-50" id="all-content">
                ...
                //                 <a class="rowTitle ltr-0 d-flex" onMouseOver={exploreAll()}>
                //                     <div class="row-header-title text-capitalize">{id} and {genre}</div>
                //                     <div class="aro-row-header d-flex">
                //                         <div class="see-all-link">Explore All</div>
                //                         <div class="aro-row-chevron icon-akiraCaretRight"><FaChevronRight/></div>
                //                     </div>
                //                 </a>
                //             </h2>
